<template>
    ...
    <div class="blog-card spring-fever" v-for="article of news.articles" v-bind:style="{ backgroundImage: 'url(' + article.urlToImage + ')' }">
        <div class="col-sm-6">
  <div class="title-content">
    <h3><a href="#">{{article.title}}</a></h3>
    <div class="intro"> <a href="#">{{article.author}}</a> </div>
  </div>
  <div class="card-info">
    {{article.description}} 
...
<script>
  ...
  async fetch() {
    this.news = await fetch(
      "https://newsapi.org/v2/top-headlines?country=us&apiKey=d5f3546e9149431daa481e6c66bb7ad1"
    ).then(res => res.json());
  }
    }
</script>
